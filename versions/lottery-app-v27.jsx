// ============================================================
// Lottery Analyzer — Version 27
// ============================================================
// CHANGELOG v27 (Phase E — ขั้น 0):
//   ~ แก้: history ordering newest-first → newest-last
//          ([entry, ...history] → [...history, entry]) ตรงกับ automation
//   + เพิ่ม: createdAt ใน history entry
// CHANGELOG v26 (Phase A1 + A2 + B1):
//   ~ B1: แยก engine.js — import จาก ./engine.js แทนนิยามใน App
// CHANGELOG v26 (Phase A1 + A2):
//   + เพิ่ม: สีความถี่ตำแหน่ง (4 ระดับ auto-scale) + legend
//   + เพิ่ม: lockedHints กลุ่มแยก + สี heatmap
//   ~ แก้: boost lockedHints normalize (MAX_LOCKED_BOOST=5)
// ============================================================
...
export default function App() {
  ...
  const handleSubmitActual = () => {
    ...
    const newHist = [...history, entry].slice(-50);
    ...
    <div style={{ minHeight:"100vh", background:P.bg, color:P.text, fontFamily:"'Segoe UI',sans-serif", padding:"16px 12px" }}>
      ...
      <div style={{ maxWidth:640, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:14 }}>
          <div style={{ fontSize:10, letterSpacing:4, color:P.accent, textTransform:"uppercase", marginBottom:4 }}>Adaptive Probability Engine v27</div>
