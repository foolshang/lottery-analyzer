...
// ============================================================
// CHANGELOG v26 (Phase A1 + A2 + B1):
//   ~ B1: แยก engine.js — import จาก ./engine.js แทนนิยามใน App
//         (extractDigits, parseLine, parseAll, initWeights, buildFreq,
//          buildPosFreq, buildFullPosFreq, buildLockedHintsFreq,
//          getFreqLevel, getFreqMinMax, boostPosFreq, applyNormalizedBoost,
//          convertHintsToBoost, pickHalf, analyze, adjustWeights,
//          buildComparison, chiSquareDigits, constants)
...
import {
  LEARN_RATE, MAX_W, MAX_LOCKED_BOOST, FREQ_COLORS, FREQ_LABELS,
  extractDigits, parseLine, parseAll, initWeights,
  buildFreq, buildPosFreq, buildFullPosFreq, buildLockedHintsFreq,
  getFreqLevel, getFreqMinMax, boostPosFreq, applyNormalizedBoost,
  convertHintsToBoost, pickHalf, analyze, adjustWeights,
  buildComparison, chiSquareDigits,
} from "./engine.js";
