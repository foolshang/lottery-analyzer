// ============================================================
// Lottery Analyzer — Version 21
// ============================================================
// CHANGELOG v21:
//   - ลบ: ช่อง "ทุกตำแหน่ง" ในข้อมูลเพิ่มเติม
//   + เพิ่ม: Enter ในช่อง 3 หลัง → เพิ่มชุดใหม่ + cursor ที่ 3 หลัง
//   + เพิ่ม: Enter ในช่องผลจริง → เลื่อนช่องถัดไป (6→3หน้า→3หลัง→2หลัง→ยืนยัน)
//   ~ แก้: Enter หยุดที่ช่องนั้นถ้าใส่ไม่ครบ
// ============================================================
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "stretch", gap: 0 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <input id={`hint-back-${idx}`} value={back} onChange={(e) => onChangeBack(e.target.value)} onKeyDown={handleKey} placeholder="4 5 6" maxLength={5}
            style={{ width: "100%", boxSizing: "border-box",
              background: P.card,
...
function PrizeInput({ id, label, color, value, onChange, maxLen, placeholder, slots, onEnter }) {
  ...
  return (
    <div style={{ background: P.bg, border: `1px solid ${color}33`, borderRadius: 10, padding: "10px 12px", marginBottom: 8 }}>
      ...
      <input id={id} value={value} onChange={(e) => onChange(e.target.value)} onKeyDown={handleKey} placeholder={placeholder} maxLength={maxLen + 2}
    ...
    <div style={{ minHeight:"100vh", background:P.bg, color:P.text, fontFamily:"'Segoe UI',sans-serif", padding:"16px 12px" }}>
      ...
      <div style={{ maxWidth:640, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:14 }}>
          <div style={{ fontSize:10, letterSpacing:4, color:P.accent, textTransform:"uppercase", marginBottom:4 }}>Adaptive Probability Engine v21</div>
