// ============================================================
// Lottery Analyzer — Version 24
// ============================================================
// CHANGELOG v24:
//   + เพิ่ม: เก็บ Log ทุกรอบใน Firestore subcollection "logs/" (ไม่จำกัด)
//   + เพิ่ม: ปุ่ม "Export .csv" — ดาวน์โหลดทุกรอบในรูปแบบ key-value
//   ~ แก้: ปุ่ม "ดู Log ล่าสุด" — เปิด popup ในแอป (เหมือนเดิม)
//   - ลบ: ปุ่มดาวน์โหลด .txt
// ============================================================
    ...
    <div style={{ minHeight:"100vh", background:P.bg, color:P.text, fontFamily:"'Segoe UI',sans-serif", padding:"16px 12px" }}>
      ...
      <div style={{ maxWidth:640, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:14 }}>
          <div style={{ fontSize:10, letterSpacing:4, color:P.accent, textTransform:"uppercase", marginBottom:4 }}>Adaptive Probability Engine v24</div>
